...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Mar 2024 pada 18.04
...
INSERT INTO `pelanggan` (`pelanggan_id`, `nama_pelanggan`, `alamat`, `nomor_telepon`, `status`) VALUES
(58, 'ucok', 'Jalan Gajah Mada', '085888060024', 'tampil'),
(59, 'Asep', 'kota baru presiden', '08590123902', 'tampil');
...
INSERT INTO `penjualan` (`penjualan_id`, `tanggal_penjualan`, `pelanggan_id`, `created_at`, `TotalHarga`, `status`, `uang`, `kembalian`) VALUES
(1, '2024-03-20', 58, '2024-03-20 23:10:37', 30000, 'selesai', 40000, 10000),
(2, '2024-03-20', 58, '2024-03-20 23:29:53', 4000, 'selesai', 5000, 1000);
...
(14, 'Hidrococo', 2000, 9996, 'tampil'),
(15, 'Telur', 2600, 9990, 'tampil');
...
(5, 'sueb', 'alhamdulillah', 'petugas', '$2y$12$1aYXN/OMYe9Y95aMOOKko.Pb6xqrMfjnXUCRiETCZxXzPwPC5vFQW');
...
--
ALTER TABLE `detail_penjualan`
  MODIFY `detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
--
ALTER TABLE `pelanggan`
  MODIFY `pelanggan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
